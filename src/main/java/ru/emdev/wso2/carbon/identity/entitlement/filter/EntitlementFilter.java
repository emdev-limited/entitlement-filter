package ru.emdev.wso2.carbon.identity.entitlement.filter;
...
/** This is super-class for default EntitlementFilter which allowed to use not only requestURI - but also servletPath
 * as a resource
 * 
 * Unfortunately - since method findResource is private - we cannot just override it - so, we should fully reimplement (via copy-paste)
 * default WSO2 implementation
 * 
 * @author akakunin
 *
 */
